...
//
//		if (dtoMouvement.getPseudo() == null || dtoMouvement.getPseudo().isEmpty()) {
//			message.append("\nLe pseudo est absent.");
//		} else if (dtoMouvement.getPseudo().length() < 3) {
//			message.append("\nLe pseudo est trop court.");
//		} else if (dtoMouvement.getPseudo().length() > 25) {
//			message.append("\nLe pseudo est trop long.");
//		} else if (!daoMouvement.verifierUnicitePseudo(dtoMouvement.getPseudo(), dtoMouvement.getId())) {
//			message.append("\nLe pseudo " + dtoMouvement.getPseudo() + " est déjà utilisé.");
//		}
//
//		if (dtoMouvement.getMotDePasse() == null || dtoMouvement.getMotDePasse().isEmpty()) {
//			message.append("\nLe mot de passe est absent.");
//		} else if (dtoMouvement.getMotDePasse().length() < 3) {
//			message.append("\nLe mot de passe est trop court.");
//		} else if (dtoMouvement.getMotDePasse().length() > 25) {
//			message.append("\nLe mot de passe est trop long.");
//		}
//
//		if (dtoMouvement.getEmail() == null || dtoMouvement.getEmail().isEmpty()) {
